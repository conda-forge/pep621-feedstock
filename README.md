...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pep621-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14846&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pep621-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pep621` can be installed with:

```
conda install pep621
```

It is possible to list all of the versions of `pep621` available on your platform with:
